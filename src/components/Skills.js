...
const skills = [
  {
    ...
    list: [
      ...
      { name: 'FDA 510(k)', icon: 'https://cdn-icons-png.flaticon.com/512/3145/3145765.png' },
      { name: 'ISO 14971 / 13485', icon: 'https://cdn-icons-png.flaticon.com/512/1040/1040230.png' },
      { name: 'DFMEA', icon: 'https://cdn-icons-png.flaticon.com/512/1040/1040214.png' },
      { name: 'Clinical Protocols', icon: 'https://cdn-icons-png.flaticon.com/512/3771/3771435.png' },
      { name: 'SaMD / IEC 62304', icon: 'https://cdn-icons-png.flaticon.com/512/5358/5358780.png' },
    ],
  },
  {
    title: 'Languages & ML Tools',
    list: [
